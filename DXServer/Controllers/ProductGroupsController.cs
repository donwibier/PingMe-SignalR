...
namespace DXServer.Controllers
{
    public class ProductGroupsController : Controller
    {
        ...
        [HttpGet]
        public ActionResult ListProductGroups(DataSourceLoadOptions loadOptions)
        {
            var response = DataSourceLoader.Load(db.ProductGroups, loadOptions);
        ...
        public ActionResult Create([Bind(Include = "Id,Description")] ProductGroup productGroup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Description")] ProductGroup productGroup)
        {
            if (ModelState.IsValid)
            {
